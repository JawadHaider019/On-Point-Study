          ...
          <div className="relative">
            ...
            >
              <div className="relative">
                ...
                />
                <span
                  className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full ring-2 ring-white ${currentUser.role === 'ADMIN' ? 'bg-amber-500' : 'bg-blue-600'
                    }`}
                />
              </div>
              ...
              <div className="hidden lg:block">
                ...
                <div className="text-[10px] text-slate-500 font-medium">
                  {currentUser.role === 'ADMIN' ? ' Admin' : currentUser.agentName}
                </div>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  {initialUsers.map((u) => (
                    <button
                      ...
                      className={`w-full text-left p-2 rounded-lg flex items-center justify-between transition-colors ${currentUser.id === u.id
